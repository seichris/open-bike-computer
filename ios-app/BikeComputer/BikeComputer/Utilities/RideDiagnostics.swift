...
nonisolated enum RideDiagnosticsFieldPolicy {
    static let allowedKeys: Set<String> = [
        ...
        "attemptId", "authorization", "authorized", "available",
        "background", "blockLoadMs", "bootSequence", "bytes", "chunk", "class", "code",
        "clockSynchronized",
        "commandClass", "connectionGeneration", "controllerRole",
        "completedStage", "consecutiveEarlyFailures", "diagnosticHold",
        "domain", "droppedCount", "durationLimit", "durationMs",
        "enqueuedCount", "eventCount", "featureFlags", "generation",
        "firstMissingUptimeMs", "firmwareBuild", "firmwareFingerprint",
        "firmwareTarget", "fixValid", "formatVersion", "importedCount",
        "highWater", "highWaterBytes", "lastCriticalCategory", "latencyMs", "leaseGeneration",
        "lastCriticalEvent", "lastGapMs", "lastMissingUptimeMs",
        "lastFailureStage", "lastFailureCompletedStage",
        "lastFailureResetReason",
        "mapDetail", "mapId", "mapPhase", "mapProgressMs", "maxQueueDepth",
        "members",
        "storageErrorCount",
        "maximumGapMs", "messageBytes", "messageDigest", "kind", "mode",
        "networkTransport", "navigating",
        "outcome", "phase", "profileVersion", "queueBytes", "queueDepth", "ready", "reason",
        "rejectedCount", "replacedCount", "resetReason", "retries", "role",
        "rideDetectionArmed",
        "rideGeneration", "routeLoaded", "rssiBucket", "sampleCount",
        "runtimeBootSequence", "schemaVersion", "sizeBucket",
        ...
        "fallback",
        "viewingMap", "visitedEntries", "watchSequence", "watchUptimeMs",
        "watchdogCoreMask", "watchdogUptimeMs",
        "workoutActive",
        "writerDetail", "writerPhase", "writerProgressMs", "writtenCount",
    ]
    static let firmwareNumberKeys: Set<String> = [
        "accuracy", "activeStage", "ageMs", "alertMode", "blockLoadMs",
        "bootSequence", "commandClass", "connectionGeneration",
        "bytes", "chunk", "completedStage", "consecutiveEarlyFailures",
        "decisionSequence", "droppedCount", "durationMs", "enqueuedCount",
        "eventCount", "firmwareBuild", "formatVersion", "generation",
        ...
        "highWater", "highWaterBytes", "latencyMs", "leaseGeneration", "members",
        "messageBytes", "profileVersion", "queueBytes", "queueDepth", "rejectedCount",
        "replacedCount", "resetReason", "retries",
        "rideGeneration",
        "runtimeBootSequence", "sampleCount", "schemaVersion", "sequence", "sourceHealthMask",
        "storageErrorCount", "uiProgressMs", "visitedEntries", "watchdogCoreMask",
        "watchSequence", "watchUptimeMs", "watchdogUptimeMs", "writerDetail",
