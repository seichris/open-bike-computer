...
nonisolated enum RideDiagnosticsFieldPolicy {
    static let allowedKeys: Set<String> = [
        ...
        "acknowledgedKind", "ageMs", "alertMode", "applyErrorCode",
        "applyErrorDomain", "applyResult", "attempt", "autoPauseEnabled",
        "authorization", "authorized", "available",
        "background", "blockLoadMs", "bootSequence", "bytes", "chunk", "code",
        "clockSynchronized", "connectCompleted", "connectDurationMs",
        "connectStarted", "connectionReused",
        "completedStage", "consecutiveEarlyFailures", "diagnosticHold",
        "domain", "droppedCount", "durationLimit", "durationMs", "errorCode",
        "errorDomain",
        "enqueuedCount", "eventCount",
        ...
        "httpStatus", "lastFailureResetReason", "localAccessorySubnet",
        "mapDetail", "mapId", "mapPhase", "mapProgressMs", "maxQueueDepth",
        "storageErrorCount",
        "maximumGapMs", "messageBytes", "messageDigest", "kind", "mode",
        "networkObservation", "networkProtocol", "networkTransport", "navigating",
        "outcome", "profileVersion", "proxyConnection", "queueDepth", "ready",
        "reason", "remoteEndpointMatched", "resetReason",
        "rideDetectionArmed",
        ...
        "tlsChallenge", "tlsCompleted", "tlsDurationMs", "tlsStarted",
        "transition", "uiPhase", "uiProgressMs", "underlyingErrorCode",
        "underlyingErrorDomain", "result", "origin",
    ...
    static let firmwareNumberKeys: Set<String> = [
        ...
        "messageBytes", "profileVersion", "queueDepth", "resetReason",
        "rideGeneration",
