...
For app client version 7 and later, introduce `CAP2`:
...
| ID | Profile | Value |
| ---: | --- | --- |
| 25 | Map | label density 0...3 |
| 26 | Map | language mode 0...2 |
| 27 | Map | text size 0...2 |
| 28 | Map | orientation 0...1 |
| 29 | Map + Navigation | label density 0...3 |
| 30 | Map + Navigation | language mode 0...2 |
| 31 | Map + Navigation | text size 0...2 |
| 32 | Map + Navigation | orientation 0...1 |
...
2. Add setting IDs 25...32, NVS/UserDefaults persistence, and profile sync.
...
- independent profile persistence and sends for IDs 25...32;
