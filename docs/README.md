...
| Plan | Status |
| --- | --- |
| [Topographic map support](plans/issue-190-topographic-map-support-implementation-plan.md) | Free/global direction selected; [acquisition and contour evidence](topography-pipeline.md) implemented; app/device integration pending; tracks [issue #190](https://github.com/seichris/open-bike-computer/issues/190) |
