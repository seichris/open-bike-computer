...
- Regional implementation update: [native staging, inspection, bounded sampling, pinned offline transformation contracts and development-pair encoding](../topography-regional-ingestion.md) are implemented. Real provider transformations, source-boundary QA and production approval remain pending.
