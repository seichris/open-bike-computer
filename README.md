...
## Map Coordinate Calibration (China) Still need to make this more accurate

To fix a ~50m "South-West" map alignment issue in China, a manual calibration offset is applied to all coordinates sent to the device.
- **Offset X (Longitude):** +0.00052 (approx 50m East)
- **Offset Y (Latitude):** +0.00045 (approx 50m North)
- **Code:** [CoordinateConverter.swift](file:///Users/chris/Documents/Workspace/esp32-bike-computer/ios-app/BikeComputer/BikeComputer/Utilities/CoordinateConverter.swift) in `applyCalibration()`
