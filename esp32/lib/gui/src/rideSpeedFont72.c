 ...
 * Size: 72 px
 * Bpp: 4
 * Opts: --size 72 --bpp 4 --format lvgl --font .pio/libdeps/WAVESHARE_AMOLED_175/lvgl/scripts/built_in_font/Montserrat-Medium.ttf -r 0x2D-0x2E,0x30-0x39 --no-compress --no-prefilter --no-kerning --lv-include lvgl.h --lv-font-name ride_speed_font_72 -o lib/gui/src/rideSpeedFont72.c
 ******************************************************************************/
...
#ifndef RIDE_SPEED_FONT_72
#define RIDE_SPEED_FONT_72 1
#endif

#if RIDE_SPEED_FONT_72
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t ride_speed_font_72 = {
#else
lv_font_t ride_speed_font_72 = {
#endif
