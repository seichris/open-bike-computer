...
void createSearchSatScr() {
  log_i("createSearchSatScr() called");
  ...
  log_i("searchSatScreen created at 0x%p", searchSatScreen);
  ...
  lv_obj_set_flex_align(buttonBar, LV_FLEX_ALIGN_END, LV_FLEX_ALIGN_CENTER,
  ...
  lv_obj_add_event_cb(imgBtn, buttonEvent, LV_EVENT_PRESSED,
                      (char *)"settings");
