...
void createButtonBarScr() {
  ...
  lv_obj_set_flex_align(buttonBar, LV_FLEX_ALIGN_CENTER, LV_FLEX_ALIGN_CENTER,
  ...
  lv_obj_add_flag(
      menuBtn, (lv_obj_flag_t)(LV_OBJ_FLAG_FLOATING | LV_OBJ_FLAG_CLICKABLE));
  ...
  lv_obj_add_event_cb(imgBtn, buttonBarEvent, LV_EVENT_PRESSED,
                      (char *)"addwpt");
...
void loadOptions() {
  ...
  lv_obj_set_flex_align(option, LV_FLEX_ALIGN_CENTER, LV_FLEX_ALIGN_CENTER,
                        LV_FLEX_ALIGN_CENTER);
  ...
  //   lv_obj_add_flag(imgBtn, LV_OBJ_FLAG_CLICKABLE);
  //   lv_obj_add_event_cb(imgBtn, optionEvent, LV_EVENT_PRESSED,
  //   (char*)"save");
  // }
