...
constexpr const char *kAllowedFieldKeys[] = {
    ...
    "ageMs",                    "alertMode",               "applyErrorCode",
    "applyErrorDomain",         "applyResult",             "attempt",
    "autoPauseEnabled",
    "authorization",            "authorized",               "available",
    "background",               "blockLoadMs",              "bootSequence",
    "bytes",
    "chunk",                    "code",                     "completedStage",
    "clockSynchronized",        "connectCompleted",         "connectDurationMs",
    "connectStarted",           "connectionReused",         "connectionState",
    "consecutiveEarlyFailures", "decisionSequence",
    "diagnosticHold",           "domain",                   "droppedCount",
    "durationLimit",            "durationMs",                "enqueuedCount",
    ...
    "httpStatus",               "localAccessorySubnet",
    "mapDetail",                "mapId",                     "mapPhase",
    "mapProgressMs",
    "maxQueueDepth",            "maximumGapMs",               "messageBytes",
    "messageDigest",
    "mode",                     "navigating",                "networkObservation",
    "networkProtocol",          "networkTransport",          "origin",
    "outcome",                  "pendingControl",            "profileVersion",
    "proxyConnection",          "queueDepth",                "ready",
    "reason",                   "remoteEndpointMatched",
    "resetReason",
    ...
    "tlsChallenge",             "tlsCompleted",               "tlsDurationMs",
    "tlsStarted",               "transition",                 "uiPhase",
    "uiProgressMs",             "underlyingErrorCode",        "underlyingErrorDomain",
    "viewingMap",               "visitedEntries",            "waitedForConnectivity",
    "watchdogCoreMask",
    "watchdogUptimeMs",
...
inline bool allowedFieldValueKind(const char *key, FieldValueKind kind) {
  static constexpr const char *kNumberKeys[] = {
      ...
      "alertMode",        "applyErrorCode",    "attempt",
      "blockLoadMs",      "bootSequence",
      "bytes",
      "chunk",            "completedStage",    "consecutiveEarlyFailures",
      "connectDurationMs", "decisionSequence", "droppedCount",
      "durationMs",       "enqueuedCount",     "errorCode",
      "eventCount",
      "firmwareBuild",    "firstMissingUptimeMs", "formatVersion",
      "httpStatus",
      "importedCount",
      "lastGapMs",        "lastMissingUptimeMs", "maxQueueDepth",
      "maximumGapMs",
      "lastFailureStage", "lastFailureCompletedStage", "lastFailureResetReason",
      "mapDetail",        "mapProgressMs",     "messageBytes",
      "profileVersion",   "queueDepth",        "resetReason",
      "rideGeneration",   "runtimeBootSequence", "sampleCount",
      "sequence",         "sourceHealthMask",  "storageErrorCount",
      "tlsDurationMs",    "uiProgressMs",     "underlyingErrorCode",
      "visitedEntries",   "watchdogCoreMask",
      "watchdogUptimeMs",
  ...
  static constexpr const char *kBooleanKeys[] = {
      ...
      "clockSynchronized", "connectCompleted", "connectStarted",
      "connectionReused", "diagnosticHold",   "fallback",
      "fixValid",         "localAccessorySubnet", "navigating",
      "pendingControl",   "proxyConnection",  "ready",
      "remoteEndpointMatched", "rideDetectionArmed", "routeLoaded",
      "safeMode",         "sessionPresent",   "simulation",
      "speedAvailable",   "tlsCompleted",     "tlsStarted",
