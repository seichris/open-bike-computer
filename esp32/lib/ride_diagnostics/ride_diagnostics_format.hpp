...
constexpr const char *kAllowedFieldKeys[] = {
    ...
    "acknowledgedKind",  "active",            "activeStage",
    "ageMs",             "alertMode",         "attemptId",
    "autoPauseEnabled",  "authorization",     "authorized",
    "available",         "background",        "blockLoadMs",
    "bootSequence",      "bytes",             "chunk",
    "class",             "clockSynchronized", "code",
    "commandClass",      "completedStage",    "connectionGeneration",
    "connectionState",   "consecutiveEarlyFailures",
    "controllerRole",    "decisionSequence",  "diagnosticHold",
    "domain",            "droppedCount",      "durationLimit",
    "durationMs",        "enqueuedCount",     "eventCount",
    "expectedState",     "fallback",          "featureFlags",
    "firmwareBuild",     "firmwareFingerprint", "firmwareTarget",
    "firstMissingUptimeMs", "fixValid",       "formatVersion",
    "generation",        "highWater",         "highWaterBytes",
    "importedCount",     "kind",              "lastCriticalCategory",
    "lastCriticalEvent", "lastFailureCompletedStage",
    "lastFailureResetReason", "lastFailureStage", "lastGapMs",
    "lastMissingUptimeMs", "latencyMs",       "leaseGeneration",
    "mapDetail",         "mapId",             "mapPhase",
    "mapProgressMs",     "maxQueueDepth",     "maximumGapMs",
    "members",           "messageBytes",      "messageDigest",
    "mode",              "navigating",        "networkTransport",
    "origin",            "outcome",           "pendingControl",
    "phase",             "profileVersion",    "queueBytes",
    "queueDepth",        "ready",             "reason",
    "rejectedCount",     "replacedCount",     "resetReason",
    "result",            "retries",           "rideDetectionArmed",
    "rideGeneration",    "role",              "routeLoaded",
    "rssiBucket",        "runtimeBootSequence", "safeMode",
    "sampleCount",       "schemaVersion",     "scope",
    "sequence",          "sessionPresent",    "sha256Prefix",
    "simulation",        "sizeBucket",        "sourceHealthMask",
    "speedAvailable",    "startMode",         "state",
    "storage",           "storageErrorCount", "transition",
    "uiPhase",           "uiProgressMs",      "viewingMap",
    "visitedEntries",    "watchSequence",     "watchUptimeMs",
    "watchdogCoreMask",  "watchdogUptimeMs",  "workoutActive",
...
inline bool allowedFieldValueKind(const char *key, FieldValueKind kind) {
  static constexpr const char *kNumberKeys[] = {
      ...
      "alertMode",         "blockLoadMs",       "bootSequence",
      "bytes",             "chunk",             "commandClass",
      "completedStage",    "connectionGeneration",
      "consecutiveEarlyFailures", "decisionSequence", "droppedCount",
      "durationMs",        "enqueuedCount",     "eventCount",
      "firmwareBuild",     "firstMissingUptimeMs", "formatVersion",
      "generation",        "highWater",         "highWaterBytes",
      "importedCount",     "lastFailureCompletedStage",
      "lastFailureResetReason", "lastFailureStage", "lastGapMs",
      "lastMissingUptimeMs", "latencyMs",       "leaseGeneration",
      "mapDetail",         "mapProgressMs",     "maxQueueDepth",
      "maximumGapMs",      "members",           "messageBytes",
      "profileVersion",    "queueBytes",        "queueDepth",
      "rejectedCount",     "replacedCount",     "resetReason",
      "retries",           "rideGeneration",
      "runtimeBootSequence", "sampleCount",     "schemaVersion",
      "sequence",          "sourceHealthMask",  "storageErrorCount",
      "uiProgressMs",      "visitedEntries",    "watchSequence",
      "watchUptimeMs",     "watchdogCoreMask",  "watchdogUptimeMs",
