...
int main() {
  ...
  assert(MAP_NAVIGATION_3D_BUILDINGS_SETTING_ID == 35);
  assert(isIndependentSetting(MAP_NAVIGATION_3D_BUILDINGS_SETTING_ID));
  assert(clampValue(MAP_NAVIGATION_3D_BUILDINGS_SETTING_ID, -1) == 0);
  assert(clampValue(MAP_NAVIGATION_3D_BUILDINGS_SETTING_ID, 2) == 1);
